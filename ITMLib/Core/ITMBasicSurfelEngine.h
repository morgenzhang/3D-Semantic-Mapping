...
namespace ITMLib
{
	...
	public:
		...
		ITMTrackingState::TrackingResult ProcessFrame(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ITMUShort12Image *semanticImage, ITMIMUMeasurement *imuMeasurement = NULL);
