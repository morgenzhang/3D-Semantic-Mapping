...
// main
template <typename TVoxel, typename TIndex>
ITMTrackingState::TrackingResult ITMBasicEngine<TVoxel,TIndex>::ProcessFrame(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ITMUShort12Image *semanticImage, ITMIMUMeasurement *imuMeasurement)
{
	// prepare image and turn it into a depth image
	if (imuMeasurement == NULL) viewBuilder->UpdateView(&view, rgbImage, rawDepthImage, semanticImage, settings->useBilateralFilter);
	else viewBuilder->UpdateView(&view, rgbImage, rawDepthImage, semanticImage, settings->useBilateralFilter, imuMeasurement);
...
void ITMBasicEngine<TVoxel,TIndex>::GetImage(ITMUChar4Image *out, GetImageType getImageType, ORUtils::SE3Pose *pose, ITMIntrinsics *intrinsics)
{
	...
	case ITMBasicEngine::InfiniTAM_IMAGE_ORIGINAL_DEPTH:
		...
		break;
//    case ITMBasicEngine::InfiniTAM_IMAGE_ORIGINAL_SEMANTIC:
//        out->ChangeDims(view->semantic->noDims);
//        if (settings->deviceType == ITMLibSettings::DEVICE_CUDA)
//            out->SetFrom(view->semantic, ORUtils::MemoryBlock<Vector20f>::CUDA_TO_CPU);
//        else out->SetFrom(view->semantic, ORUtils::MemoryBlock<Vector20f>::CPU_TO_CPU);
//        break;

	case ITMBasicEngine::InfiniTAM_IMAGE_SCENERAYCAST:
	case ITMBasicEngine::InfiniTAM_IMAGE_COLOUR_FROM_VOLUME:
	case ITMBasicEngine::InfiniTAM_IMAGE_COLOUR_FROM_SEMANTIC:
	...
	case ITMBasicEngine::InfiniTAM_IMAGE_COLOUR_FROM_CONFIDENCE:
		...
		case ITMBasicEngine::InfiniTAM_IMAGE_COLOUR_FROM_VOLUME:
			...
			break;
		case ITMBasicEngine::InfiniTAM_IMAGE_COLOUR_FROM_SEMANTIC:
			imageType = IITMVisualisationEngine::RENDER_COLOUR_FROM_SEMANTIC;
			break;
		default:
	...
	case ITMBasicEngine::InfiniTAM_IMAGE_FREECAMERA_COLOUR_FROM_SEMANTIC:
	...
	case ITMBasicEngine::InfiniTAM_IMAGE_FREECAMERA_COLOUR_FROM_CONFIDENCE:
	{
		...
		else if (getImageType == ITMBasicEngine::InfiniTAM_IMAGE_FREECAMERA_COLOUR_FROM_SEMANTIC) type = IITMVisualisationEngine::RENDER_COLOUR_FROM_SEMANTIC;
