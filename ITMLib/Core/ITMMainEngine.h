	...
	*/
	...
	public:
		enum GetImageType
		{
            ...
            InfiniTAM_IMAGE_ORIGINAL_SEMANTIC,
            ...
            InfiniTAM_IMAGE_COLOUR_FROM_SEMANTIC,
            ...
            InfiniTAM_IMAGE_FREECAMERA_COLOUR_FROM_SEMANTIC,
        ...
        virtual ITMTrackingState::TrackingResult ProcessFrame(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ITMUShort12Image *semanticImage, ITMIMUMeasurement *imuMeasurement = NULL) = 0;
		...
		/// Extracts a mesh from the current scene and savesn it to the model file specified by the file name
