...
namespace ITMLib
{
	...
	public:
		...
		void UpdateView(ITMView **view, ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, ITMUShort12Image *semanticImage, bool useBilateralFilter, bool modelSensorNoise = false, bool storePreviousImage = true);
		void UpdateView(ITMView **view, ITMUChar4Image *rgbImage, ITMShortImage *depthImage, ITMUShort12Image *semanticImage, bool useBilateralFilter, ITMIMUMeasurement *imuMeasurement, bool modelSensorNoise = false, bool storePreviousImage = true);
