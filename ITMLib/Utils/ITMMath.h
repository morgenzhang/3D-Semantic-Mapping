...
/** add vector12, the number 12 is corresponding to
 * the number of semantic class, type unsigned short*/
typedef class ORUtils::VectorX<ushort, 12> Vector12us;
typedef class ORUtils::VectorX<float, 12> Vector12f;
...
#ifndef TO_FLOAT12
#define TO_FLOAT12(x) (x).toFloat()
#endif

#ifndef TO_USHORT_ROUND12
#define TO_USHORT_ROUND12(x) (x).toUShortRound()
#endif
