...
////  Parameters used in my experiment
:   sceneParams(0.3f, 10, 0.015f, 0.1f, 40.0f, false), // small voxel size
...
//    swappingMode = SWAPPINGMODE_DELETE;
...
//					  "framesToSkip=20,framesToWeight=50,failureDec=20.0";
	...
	//// File based tracking, default path: "/home/zhangyic/Downloads/Semantic_Mapping/kitti_data/gt_pose/0x/%04i.txt"
	trackerConfig = "type=file, mask=/Users/zhangyic/Desktop/KITTI/odometry/data_odometry_poses/poseperframe/02/%04i.txt";
    //// Surfel tracking
